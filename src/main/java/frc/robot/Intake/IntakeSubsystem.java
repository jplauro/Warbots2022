...
public class IntakeSubsystem extends SubsystemBase {
    ...
    private final Debouncer intakeSwitchDebouncer;
    ...
    public IntakeSubsystem() {
        ...
        this.intakeSwitch = new DigitalInput(Constants.intakeSwitchID);
        // Only debounce on the rising edge (false --> true)
        this.intakeSwitchDebouncer = new Debouncer(Constants.intakeSwitchDebounceTime);
