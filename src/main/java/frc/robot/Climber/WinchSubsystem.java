...
public class WinchSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        SmartDashboard.putBoolean("Winch/Limit Switch", this.getWinchLimitSwitch());
    }
    ...
    public void simulationPeriodic() {
        ...
        * (ClimberConstants.WINCH_LIMIT_MAX + 1);
        ...
        SmartDashboard.putNumber("Winch/Position", this.encoder.getPosition());
        SmartDashboard.putNumber("Winch/Motor Set", this.rightMotor.get());
        SmartDashboard.putNumber("Winch/Test Pos", this.simWinch.getPositionMeters());
    }
}
